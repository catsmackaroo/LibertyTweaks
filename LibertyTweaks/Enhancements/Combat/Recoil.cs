             ...
             float recoilAssaultRiflesAmp1, float recoilAssaultRiflesAmp2, float recoilAssaultRiflesFreq1, float recoilAssaultRiflesFreq2)
        {
            ...
            if (IS_CHAR_SHOOTING(playerId))
            {
                    ...
                    || currentWeapon == (int)eWeaponType.WEAPON_PISTOL)
                {
                    ...
                    cam.Shake(CameraShakeType.ROLL_LEFT_RIGHT, CameraShakeBehaviour.CONSTANT_PLUS_FADE_IN_OUT, 140, GENERATE_RANDOM_FLOAT_IN_RANGE(recoilSmallPistolAmp1, recoilSmallPistolAmp2), GENERATE_RANDOM_FLOAT_IN_RANGE(recoilSmallPistolFreq1, recoilSmallPistolFreq2), 0f);
                }
                ...
                { // 0.2 0.3
                    ...
                    cam.Shake(CameraShakeType.ROLL_LEFT_RIGHT, CameraShakeBehaviour.CONSTANT_PLUS_FADE_IN_OUT, 160, GENERATE_RANDOM_FLOAT_IN_RANGE(recoilHeavyPistolAmp1, recoilHeavyPistolAmp2), GENERATE_RANDOM_FLOAT_IN_RANGE(recoilHeavyPistolFreq1, recoilHeavyPistolFreq2), 0f);
                }
                    ...
                    || currentWeapon == (int)eWeaponType.WEAPON_EPISODIC_2 || currentWeapon == (int)eWeaponType.WEAPON_EPISODIC_6)
                {
                    ...
                    cam.Shake(CameraShakeType.ROLL_LEFT_RIGHT, CameraShakeBehaviour.CONSTANT_PLUS_FADE_IN_OUT, 200, GENERATE_RANDOM_FLOAT_IN_RANGE(recoilShotgunsAmp1, recoilShotgunsAmp2), GENERATE_RANDOM_FLOAT_IN_RANGE(recoilShotgunsFreq1, recoilShotgunsFreq2), 0f);
                }
                    ...
                    || currentWeapon == (int)eWeaponType.WEAPON_EPISODIC_12 || currentWeapon == (int)eWeaponType.WEAPON_EPISODIC_13)
                {
                    ...
                    cam.Shake(CameraShakeType.ROLL_LEFT_RIGHT, CameraShakeBehaviour.CONSTANT_PLUS_FADE_IN_OUT, 140, GENERATE_RANDOM_FLOAT_IN_RANGE(recoilSMGAmp1, recoilSMGAmp2), GENERATE_RANDOM_FLOAT_IN_RANGE(recoilSMGFreq1, recoilSMGFreq2), 0f);
                }
